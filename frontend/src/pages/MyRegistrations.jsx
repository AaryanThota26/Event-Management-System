...
const MyRegistrations = () => {
  ...
  return (
    <>
      {/* Hero */}
      <div className="mb-xl">
        <h1 className="font-headline-lg text-headline-lg text-on-surface mb-xs">My Registrations</h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-lg">
            {registrations.map((reg) => (
              <Link
                ...
                className="group bg-surface-container-lowest border border-outline-variant rounded-2xl p-lg hover:shadow-lg transition-all duration-300 block"
